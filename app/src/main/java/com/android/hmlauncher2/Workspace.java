...
public class Workspace extends SmoothPagedView
    ...
    void addInScreen(View child, long container, int screen, int x, int y, int spanX, int spanY,
        ...
        if (itemInfo != null &&
                itemInfo.itemType == Favorites.ITEM_TYPE_CARD) {
            if (((LauncherAppCardInfo)itemInfo).mIsDummy) {
                markCellsAsOccupied = false;
            }
        }
    ...
    */
    ...
    public boolean acceptDrop(DragObject d) {
        ...
        Log.d("DragLayer", "acceptDrop() from Workspace called with DragObject:" + d.toString());
        ...
        if (d.dragSource != this) {
            ...
            if (dropTargetLayout != null) {
                ...
                if (foundCell) {
                    ...
                    if (container != LauncherSettings.Favorites.CONTAINER_HOTSEAT &&
                        ...
                        if (itemInfo.itemType == Favorites.ITEM_TYPE_CARD) {
                            resizeFrame = true;
                        } else {
            ...
            if (d.dragView.hasDrawn()) {
                ...
                if (info.itemType == LauncherSettings.Favorites.ITEM_TYPE_APPWIDGET ||
                        info.itemType == LauncherSettings.Favorites.ITEM_TYPE_CARD) {
    ...
    private void onDropExternal(final int[] touchXY, final Object dragInfo,
        ...
        if (info instanceof PendingAddItemInfo) {
            ...
            if ((pendingInfo.itemType == LauncherSettings.Favorites.ITEM_TYPE_APPWIDGET ||
                    pendingInfo.itemType == Favorites.ITEM_TYPE_CARD) &&
    ...
    public void animateWidgetDrop(ItemInfo info, CellLayout cellLayout, DragView dragView,
        ...
        if ((animationType == ANIMATE_INTO_POSITION_AND_RESIZE || external) && finalView != null) {
            ...
            dragView.crossFade((int) (duration * 0.8f));
                ...
                info.itemType == LauncherSettings.Favorites.ITEM_TYPE_CARD) && external) {
