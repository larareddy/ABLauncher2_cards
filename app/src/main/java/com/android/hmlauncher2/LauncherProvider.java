...
import com.android.hmlauncher2.LauncherSettings.Favorites;
...
public class LauncherProvider extends ContentProvider {
    ...
    static final String AUTHORITY = "com.android.hmlauncher2.settings";
    ...
    private static final String RESTRICTION_LAYOUT_NAME =
            "com.android.hmlauncher2.workspace.configuration.layout.name";
    ...
    public boolean onCreate() {
        ...
        {
            application = (LauncherApplication) applicationContext;
        }
        else
        {
            ...
            try
            {
                magicField = applicationContext.getClass().getDeclaredField("LauncherApplication");
            ...
            application = (LauncherApplication) realApplication;
        }

        if (application != null)
            application.setLauncherProvider(this);
        return true;
    }
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        private static final String TAG_APPCARD = "appcard";
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            // - Passion shipped on 2.1 with version 6 of hmlauncher2
        ...
        private int loadFavorites(SQLiteDatabase db, int workspaceResourceId) {
            ...
            try {
                ...
                while (((type = parser.next()) != XmlPullParser.END_TAG ||
                    ...
                    } else if (TAG_APPCARD.equals(name)) {
                        added = addAppCard(db, values, a);
        ...
        private boolean addAppCard(SQLiteDatabase db, ContentValues values,
                                   TypedArray a) throws XmlPullParserException, IOException {
            int spanX = a.getInt(R.styleable.Favorite_spanX, 0);
            int spanY = a.getInt(R.styleable.Favorite_spanY, 0);
            final int titleResId = a.getResourceId(R.styleable.Favorite_title, 0);
            final int layoutResId = a.getResourceId(R.styleable.Favorite_layoutId, 0);

            if (layoutResId == 0 || titleResId == 0) {
            ...
            values.put(Favorites.ITEM_TYPE, Favorites.ITEM_TYPE_CARD);
            values.put(Favorites.SPANX, spanX);
            values.put(Favorites.SPANY, spanY);
            values.put(Favorites.APPWIDGET_ID, layoutResId);
            values.put(Favorites._ID, generateNewId());
            return (dbInsertAndCheck(this, db, TABLE_FAVORITES, null, values) >= 0);
        }
