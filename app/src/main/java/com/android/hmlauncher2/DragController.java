...
public class DragController {
    ...
    public void startDrag(Bitmap b, int dragLayerX, int dragLayerY,
        ...
        dragView.setTag(R.id.all_apps_cling, ((Workspace)source).mDragInfo.cell);
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (mDragging) {
                    ...
                    if (vec != null) {
                        ...
                        Log.d("DragLayer", "drop() is called from onInterceptTouchEvent() with dragLayerX:" + dragLayerX +
                                " and dragLayerY:" + dragLayerY);
        ...
        case MotionEvent.ACTION_UP:
            ...
            if (mDragging) {
                ...
                if (vec != null) {
                    ...
                    Log.d("DragLayer", "drop() is called from onTouchEvent() with dragLayerX:" + dragLayerX +
                            " and dragLayerY:" + dragLayerY);
                    drop(dragLayerX, dragLayerY);
                }
            }
    ...
    private void drop(float x, float y) {
        ...
        if (dropTarget != null) Log.d("DragLayer", "drop() found the drop target:" + dropTarget.toString());
        ...
        //Added by MC
        if (accepted) LauncherModel.updateDummyAppCard(null);
    }
