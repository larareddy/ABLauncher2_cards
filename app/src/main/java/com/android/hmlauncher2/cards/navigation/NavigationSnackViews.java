...
public class NavigationSnackViews extends LinearLayout {
    private static final String TAG = "ClimateBiteViews";
    private PageIndicator mPageIndicator;

    public NavigationSnackViews(Context context) {
        this(context, null);
    }

    public NavigationSnackViews(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
