...
public class NavigationBiteViews extends LinearLayout {
    private static final String TAG = "NavigationBiteViews";
    private PageIndicator mPageIndicator;

    public NavigationBiteViews(Context context) {
        this(context, null);
    }

    public NavigationBiteViews(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
