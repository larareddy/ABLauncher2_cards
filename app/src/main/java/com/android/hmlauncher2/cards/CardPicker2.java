...
public class CardPicker2<T> extends BaseAdapter {
    ...
    public CardPicker2(Context context, View parent) {
        mContext = context;
        mParent = parent;
        ...
        mPopUpWindow = new PopupWindow(contentView, (int)(parent.getWidth() * 0.9), (int)(parent.getHeight() * 0.9));
        ...
        mGridView = (GridView) contentView.findViewById(R.id.card_pick_content);
        mTextView = (TextView) contentView.findViewById(R.id.picker_title);
        ...
        (contentView.findViewById(R.id.btn_card_picker_cancel)).setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public CardPicker2 setListener(CardPickerListener listener) {
        mListener = listener;
        return this;
    }
    ...
    public void show() {
        if (mPopUpWindow != null) {
            mPopUpWindow.showAtLocation(mParent, Gravity.CENTER, 0, 1);
        }
    }
    ...
    public CardPicker2 setCardList(List<T> list) {
        if (!mDismissed) {
            mList = list;
    ...
    public CardPicker2 setNumColumns(int num) {
        mGridView.setNumColumns(num);
        return this;
    }

    public CardPicker2 setTitle(String title) {
