...
public class ActiveCallSnackView extends LinearLayout {
    public ActiveCallSnackView(Context context) {
        super(context);
    }
    public ActiveCallSnackView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ActiveCallSnackView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public ActiveCallSnackView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
